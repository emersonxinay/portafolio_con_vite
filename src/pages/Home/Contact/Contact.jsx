  ...
  return (
    <div id='contact' className='grid gap-16 pb-32'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 gap-4'>
        <a href='https://www.linkedin.com/in/emersonespinozaaguirre/' target={'_blank'} aria-label='Linkedin' className='h-full w-full bg-gradient-to-r  from-sky-500 to-sky-700 ring-0 rounded-xl grid place-content-center py-8 shadow-[0px_0px_10px_1px_#0284c7]'>
