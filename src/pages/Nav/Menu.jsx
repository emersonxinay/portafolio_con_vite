...
const Menu = ({ scrolled }) => {
  ...
  return (
    <div className="block lg:hidden">
      <motion.button 
        className={`relative group z-20 touch-target p-3 rounded-xl transition-all duration-300 ${
          scrolled 
      ...
      >
        <div className="relative w-6 h-6 flex items-center justify-center">
          ...
          <motion.div className="w-6 h-6 flex flex-col justify-center items-center">
            <motion.span
              className="block h-0.5 w-5 bg-white rounded-sm mb-1"
              animate={{
                rotate: menu ? 45 : 0,
                y: menu ? 6 : 0
              }}
            ...
            />
            <motion.span
              className="block h-0.5 w-5 bg-white rounded-sm"
              animate={{
                rotate: menu ? -45 : 0,
                y: menu ? -6 : 0
              }}
