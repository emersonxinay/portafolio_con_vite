    ...
    <AnimatePresence>
      ...
      >
        <div className='grid-cols-4 relative text-center items-center group grid z-20'>
          ...
          {/* Links */}
          <span onClick={closeMenu} id='home' className='font-semibold text-lg w-full'><Link to={'/'} className='w-full px-4 py-2'>{t('nav.home')}</Link></span>
          <span onClick={closeMenu} id='blog' className='font-semibold text-lg w-full'><Link to={'/blog'} className='w-full px-4 py-2'>{t('nav.blog')}</Link></span>
          <span onClick={closeMenu} id='docs' className='font-semibold text-lg w-full'><Link to={'/docs'} className='w-full px-4 py-2'>{t('nav.docs')}</Link></span>
          <span onClick={closeMenu} id='tools' className='font-semibold text-lg w-full'><Link to={'/tools'} className='w-full px-4 py-2'>{t('nav.tools')}</Link></span>
